...
namespace LESSON_1
{
    public partial class pos2_func : Form
    {
        // Backing fields copied from Example6
        ...
        public pos2_func()
        {
            ...
            // Load images into picture boxes (hard-coded paths)
        ...
        private void qtyTxtBox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                totalQty += qty;
                totalQtyTxtBox.Text += totalQty.ToString(); // (Original logic from Example6)
            ...
            {
                // Ignore parsing errors until valid numeric input
            }
        }
        ...
        private void calculateBillsBtn_Click(object sender, EventArgs e)
        {
            try
            {
                double cashGiven = Convert.ToDouble(cashGivenTxtBox.Text);
